...
namespace DDG
{
   ...
   protected:
      ...
      static void mDualMesh( void );
      static void mWeights( void );
      ...
      static void drawDualMesh( void );
      static void drawWeights( void );
      ...
      static bool renderDualMesh;
      // darw dual mesh

      static bool renderWeights;
      // darw dual mesh
