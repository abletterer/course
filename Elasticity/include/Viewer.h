...
namespace DDG
{
   ...
   public:
      ...
      static Mesh mesh, initial, source, target;
   ...
   protected:
      ...
      static void mRenderInitial( void );
      ...
      static void drawPolygons( const Mesh& surf );
      static void drawWireframe( const Mesh& surf );
      ...
      static bool animate;
      // whether we are iterating or not
